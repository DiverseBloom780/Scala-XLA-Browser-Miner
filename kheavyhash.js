...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_kheavyhash_init')) {
        Object.defineProperty(Module['ready'], '_kheavyhash_init', { configurable: true, get: function() { abort('You are getting _kheavyhash_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_kheavyhash_init', { configurable: true, set: function() { abort('You are setting _kheavyhash_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_kheavyhash')) {
        Object.defineProperty(Module['ready'], '_kheavyhash', { configurable: true, get: function() { abort('You are getting _kheavyhash on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_kheavyhash', { configurable: true, set: function() { abort('You are setting _kheavyhash on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'kheavyhash.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('kheavyhash.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _kheavyhash_init = Module["_kheavyhash_init"] = createExportWrapper("kheavyhash_init");

/** @type {function(...*):?} */
var _kheavyhash = Module["_kheavyhash"] = createExportWrapper("kheavyhash");
